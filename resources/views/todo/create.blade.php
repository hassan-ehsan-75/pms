...
<?php
/* Default values */
$_PAGE_TITLE='Create TODO';
$_PAGE_SUB_TITLE='create a new todo';
?>
@extends('layout.gui')
@section('content')
	 <form class="form-horizontal"  method="post" action="{{route('todo.store',$task_id)}}" enctype="multipart/form-data">
     {{csrf_field()}}
  <fieldset>
...
: Ready for release and publishing.
   ...
   <div class="form-group">
    ...
    <div class="col-md-6">
    <textarea id="discription"  name="description" class="ckeditor form-control input-md" required=""></textarea>
